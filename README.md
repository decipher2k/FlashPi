...
-If you do only see a blinking cursor after the bootlogo has been displayed, then there are no rom files present in the /home/pi/roms directory.<br>
 ...
 <b>-The file renaming script (which removes spaces and other special characters) is not being called in the current release due to sloppynes. Thus it is necessary to change the filenames of the roms so they don't contain either of them.</b>
